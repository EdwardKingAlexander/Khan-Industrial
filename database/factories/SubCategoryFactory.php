...
$factory->define(App\SubCategory::class, function (Faker $faker) {
    return [
        ...
        'subcategory_name' => $faker->randomElement($array = array(
        'Electrical-and-Lighting', 
        'Strapping-Products',
        'Connectors-Terminals-and-Clips', 
        'Splice-Kits', 
        'HVAC-Other', 
        ...
        'Chemicals, Lubricants-and-Paints-Other', 
        'Generators', 
        ...
        'Hand-Tools-Other', 
        'Pumping-Equipment', 
        'Compressors, Blow-Guns, Hoses-and-Fitting', 
        ...
        'Wrenches', 
        'Pneumatics', 
        'Sockets-Ratchets-Adaptors-and-Extension', 
        'Hand-Tool-Organizers-and-Belts', 
        'Locking-Devices', 
        'Welding-Supplies', 
        'Measuring-and-Leveling-Tools-Other', 
        ...
        'Demolition-Tools', 
        'Prying-Tools', 
        'Brushing-and-Sweeping-Products', 
        ...
        'Pumps-Other', 
        'Marking-Tools', 
        'Labeling-Tool-Parts-and-Accessories', 
        'Labeling-Tools', 
        'Ticket-Holders', 
        'Flashlights-and-Lanterns', 
        'Batteries', 
        'Flashlight-and-Lantern-Parts-and-Accessor', 
        ...
        'Protractors', 
        'Flange-Pins-and-Aligners', 
        'Radius-Markers', 
        'Plugs-and-Receptacles', 
        'Electrical-Tools-Other', 
        'Extension-and-Power-Cords', 
        'Power-Centers', 
        'Cord-Reels', 
        'Insect-and-Weed-Controlling-Products', 
        'Jacks-Lifts-and-Hydraulics', 'Foodservice-Supplies', 
        'Cups-and-Lids', 
        'Fall-Protection', 
        ...
        'Breakaways', 
        'Punchdown-Tools', 
        'Punchdown-Tool-Parts-and-Accessories', 
        'Testers-and-Indicator-Parts-and-Accessories', 
        ...
        'Micrometers', 
        'Square-Parts-and-Accessories', 
        'Dial-and-Digital-Indicator-Parts-and-Acce', 
        'Micrometer-Sets', 
        'Micrometer-Parts-and-Accessories', 
        'Tape-Measure-Parts-and-Accessories', 
        'Chemicals,-Lubricants-and-Paint', 
        'Gauging-Tape-Wipers', 
        'Gauging-Tapes', 
        ...
        'Battery-Chargers', 
        'Light-Bulbs', 
        'Finders-and-Scanners', 
        'Caliper-and-Divider-Parts-and-Accessories', 
        'Welding-and-Cutting-Machines', 
        'Coffee,-Sugar-and-Creamers', 
        'Unknown', 
        ...
        'Extension-and-Power-Cord-Accessories' )),
